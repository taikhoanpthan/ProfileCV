    ...
    <>
      <Row>
        <Col md={6} xs={12}>
          ...
          <div>
            <div>
              <p>Hi everyone, I am MyPhan from Ho Chi Minh City, Vietnam.</p>

              <p>
                I am currently a final-year student looking for a Fresher
                Frontend Developer position.
              </p>

              <p>
                I am studying Software Engineering at Nguyen Tat Thanh
                University (NTTU).
              </p>
            </div>
          </div>
